...
const (
	Customer_GetCustomerById_FullMethodName = "/customer.Customer/GetCustomerById"
)
...
func (c *customerClient) GetCustomerById(ctx context.Context, in *CustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error) {
...
func (UnimplementedCustomerServer) GetCustomerById(context.Context, *CustomerRequest) (*CustomerResponse, error) {
...
func _Customer_GetCustomerById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServer).GetCustomerById(ctx, req.(*CustomerRequest))
	}
